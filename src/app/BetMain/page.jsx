...
export default function BetMain(props) {
    ...
    const sportArray = ["Football", "Volley Ball", "Basket Ball", "Tennis", "Long Tennis", "Cricket", "Boxing"]
  ...
  return (
    ...
    <main className='h-[auto] w-[100%] relative flex flex-col items-center bg-[#ffffff]'>
        <BetSlip title={props.title} club={["Chealsea", "Liverpool"]} time={"18:00"}/>
        <BetSlip title={props.title} club={["Everton", "Aston Villa"]} time={"20:00"}/>
        <BetSlip title={props.title} club={["AC Millan", "Napoli"]} time={"22:00"}/>
        <BetSlip title={props.title} club={["Sevilla", "Barcelona"]} time={"22:00"}/>
    </main>
